...
export async function createProductoApi(catalogo) {
    ...
    try {
        const response = await fetch('http://localhost:8000/api/productos/create', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export async function updateProductoApi(catalogo) {
    const response = await fetch(`http://localhost:8000/api/productos/edit`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
        },
...
export async function deleteProductoApi(id) {
    const response = await fetch(`http://localhost:8000/api/productos/delete`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
        },
