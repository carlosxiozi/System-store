...
export async function update(catalogo) {
    ...
    const response = await fetch(process.env.NEXT_PUBLIC_API_URL+`/notes/edit`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
        },
...
export async function destroy(id) {
    const response = await fetch(process.env.NEXT_PUBLIC_API_URL+`/notes/delete`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
        },
...
export async function montoTotal(data) {
    ...
    const response = await fetch(process.env.NEXT_PUBLIC_API_URL+`/notes/updateTotal`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
        },
...
export async function monto_pagado(data) {
    const response = await fetch(process.env.NEXT_PUBLIC_API_URL+`/notes/updatePayment`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
        },
